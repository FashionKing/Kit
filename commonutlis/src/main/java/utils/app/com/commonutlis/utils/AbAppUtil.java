...
public class AbAppUtil {
    ...
    public static void installApk(Context context, File file) {
        ...
        android.util.Log.e("path",FileProvider.getUriForFile(context, "包名" + ".fileprovider", file).getPath());
        Intent intent = new Intent(Intent.ACTION_VIEW);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
            intent.setDataAndType(FileProvider.getUriForFile(context, "包名" + ".fileprovider", file), "application/vnd.android.package-archive");
        else
